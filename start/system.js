...
client.sendMessage(m.chat, {
      ...
      sourceUrl: 'https://youtube.com/@lynnzxdd',
      mediaType: 1,
...
sourceUrl: 'https://www.youtube.com/@lynnzxdd',
},
},
text: txt,
}
...
const qpayment = {
key: {remoteJid: '0@s.whatsapp.net', fromMe: false, id: `footer`, participant: '0@s.whatsapp.net'}, message: {requestPaymentMessage: {currencyCodeIso4217: "IDR", amount1000: 999999999, requestFrom: '0@s.whatsapp.net', noteMessage: { extendedTextMessage: { text: "LynnZxD Nih Boss"}}, expiryTimestamp: 999999999, amount: {value: 91929291929, offset: 1000, currencyCode: "INR"}}}}
...
newsletterName: `LynnZxD Dan Ruka BOT`,
jpegThumbnail: "",
caption: `RUKA BOT V1.0.0`,
...
client.updateProfileStatus(`RUKA-MD Have Been Running For ${runtime(process.uptime())}`).catch(_ => _)
}
...
//[BUG FUNCTION]
    async function XiosVirus(jid) {
			...
			console.log(chalk.red("Succes Send Bug ©LynnZxD🥶"));
    };
...
break
 ...
 let __timers = (new Date - users.lastclaim)
   ...
   if (new Date - users.lastclaim > 86400000) {
   	client.sendMessage(m.chat, { text: `*Daily Claim*\n_Successful Claim_\n- limit : 3\n\n_Claim Reset_` }, { quoted: m })
   	users.limit[m.sender].limit += 3
   	users.lastclaim[m.sender].lastclaim = new Date * 1
   } else {
   	client.sendMessage(m.chat, { text: `Please wait *⏱️${timers}* again to be able to claim again` }, { quoted: m })
   }
    }
break
case 'script': case 'sc': {
let Rawwwwr = `Script Ini Op? 20K(NO UPDATE) Saja

*If you want to ask questions, please chat :*
> ${owner}

*Jika ingin Tahu Informasi Mengenai Bot Ini :*
> _https://whatsapp.com/channel/0029VaoNzzlJJhzQTJBL5n0F_

*Jika Ingin Memainkan Bot Ini :*
> _https://chat.whatsapp.com/ICVNWOWGMpP15FP2YV5not_`
...
client.sendMessage(m.chat, {text: teks, contextInfo: {mentionedJid: [m.sender], externalAdReply: { thumbnailUrl: thumbnail, title: "© Message System Notifikasi", body: null, sourceUrl: 'https://youtube.com/@rissmdbotz', renderLargerThumbnail: true, mediaType: 1}}}, {quoted: qpayment})
})}
break
case 'daftar': { 
...
await client.groupAcceptInvite(result).then(respon => reply("* Successfully Entered Into Group Chat")).catch(error => reply(error.toString()))
}
break  
case 'customsn': {
